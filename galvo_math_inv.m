    ...
    pan_angle = 0.5*atan2(mirror(2).p(2) - p_target(2) , mirror(2).p(1) - p_target(1));
    ...
    %% 4 . find tilt angle
    tilt_angle = -0.5*atan2(mirror(2).p(3) - p_incidence(3), mirror(1).p(2) - mirror(2).p(2));
